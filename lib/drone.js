...
module.exports = function(uuid) {
	...
	this.longer = function() {
		console.log("longer");
		this.flightOptions.steps = this.flightOptions.steps >= 45 ? 50 : this.flightOptions.steps + 5;
	};
	this.shorter = function() {
		console.log("shorter");
		this.flightOptions.steps = this.flightOptions.steps <= 15 ? 10 : this.flightOptions.steps - 5;
	};
	// altitude
	this.up = function() {
		console.log("↑↑↑");
