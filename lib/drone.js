	...
	this.connect = function() {
		spider.connect(function() {
			...
			spider.setup(function() {
				...
				spider.calibrate();
				spider.startPing();
				spider.on("battery", function () {
					console.log("VOODOOTIKIGOD SAYS BATTERY: " + spider.status.battery + "%");
				});

				// spider.on("stateChange", function () {
				// 	console.log(spider.status.flying ? "-- flying" : "-- down");
				// });
